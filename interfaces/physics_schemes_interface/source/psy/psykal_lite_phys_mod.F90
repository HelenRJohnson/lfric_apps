...
&lake_h_ice_gb, lake_g_dt_gb, lake_depth_gb, hcon_lake, ts1_lake_gb, non_lake_frac, lake_t_snow_gb, u_s_std_tile, stencil_depth )
...
&ts1_lake_gb, non_lake_frac, lake_t_snow_gb, u_s_std_tile
...
&lake_t_snow_gb_proxy, u_s_std_tile_proxy
...
&undf_adspc10_dust_mrel
      ...
      lake_t_snow_gb_proxy = lake_t_snow_gb%get_proxy()
...
&lake_t_snow_gb_proxy%data, u_s_std_tile_proxy%data, ndf_wtheta, &
